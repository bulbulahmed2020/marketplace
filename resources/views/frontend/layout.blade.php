...
<link href="css/new.css?v=2.5" rel="stylesheet" type="text/css">
				...
				<div class="col s12">
					<div class="d-table">
						<div class="d-tablecell logo-container">
							<a href="index.php" class="logo"><img src="images/logo-v2.png" srcset="images/logo-v2@2x.png 2x" alt="logo"></a>
...
<div class="author-div">
	<div class="prof-img">
		<img src="images/home-img/prof-img.png" srcset="images/home-img/prof-img@2x.png 2x" alt="profile">

	</div>
	<div class="prof-info">
		<img src="images/home-img/sign.svg" alt="sign"/>
...
and comprehensive wealth management capabilities designed to help you succeed.</h5>
				 ...
				 <form class="col s12 m12 l12 xl12 form-new">
      
        <div class="input-field ">
        	 <label>Full Name</label>
          <input placeholder="John Smith" type="text" class="form_control">
          ...
          <div class="input-field">
        	 <label>E-mail</label>
          <input placeholder="johnsmith@example.com" type="email" class="form_control">
       ...
       <div class="input-field">
        	 <label>Phone</label>
          <input placeholder="(XXX) XXX-XXXX" type="number" class="form_control">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col s12 m6 l6 xl6">
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/MAKO_SURGICAL_CEROS.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
	...
	<div class="col s12 m6 l6 xl6">
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/ABBOT_CEROS.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/PROCEPT_BIOROBOTICS.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/AURIS.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
			...
			<div class="col s12 m6 l6 xl6">
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/Magic-Leap-logo.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/DERMO.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/Insightec.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/Shockwave-Logo.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/Potrero-logo.svg" alt="logo"/>
...
<h5><a href="#">Request More Info +</a></h5>
				...
				<div class="icon-div">
					<div class="icon-img">
						<img src="images/home-img/HistoSonics.svg" alt="logo"/>
...
<div class="footeradtn">
	<img src="images/footer-img.png" alt=""  srcset="images/footer-img@2x.png 2x">
</div>
				</div>
			</div>
			<div class="col s6 m3 l3 xl3">
				<div class="ft-menu right-align ft-logo">
					<a href="index.php"><img src="images/logo2.svg"></a>
				</div>
			</div>
		</div>
		<div class="row">
